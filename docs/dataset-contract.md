...
New Actions-discovery canary partitions use `polymarket-15m-seven-canary-v6-*` Releases. A bounded
...
Earlier v1/v2/v3/v4/v5 canary Releases remain immutable isolated evidence. Authenticated v4/v5 Tier A

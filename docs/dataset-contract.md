...
New Actions-discovery canary partitions use `polymarket-15m-seven-canary-v5-*` Releases. A bounded
...
Earlier v1/v2/v3/v4 canary Releases remain immutable isolated evidence. Authenticated v4 Tier A

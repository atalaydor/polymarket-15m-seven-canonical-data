...
The canary searches a finite list of source-backed, exact, resolved 15-minute windows, stops at the
newest window common to all seven assets, verifies both the warm-up and market-hour PMXT objects,
downloads the least hourly PMXT inventory needed for that window, and

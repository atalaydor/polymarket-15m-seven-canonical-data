...
class InventoryAndAcquisitionTests(unittest.TestCase):
    ...
    def test_pmxt_capacity_is_measured_and_cumulative_without_shared_multiplication(self) -> None:
        self.assertEqual(PMXT_ROWS_PER_MARKET_WITH_MARGIN, 2_025_690)
        self.assertEqual(PMXT_ROWS_PER_MARKET_OBJECT_WITH_MARGIN, 1_012_845)
        ...
        self.assertEqual(configured["max_pmxt_filtered_rows_per_market"], 2_025_690)
        self.assertEqual(
